  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-[#060A17] via-[#0A0F1F] to-[#121826] p-6">
      <div className="absolute inset-0 overflow-hidden">
        <motion.div
          className="absolute top-1/4 left-1/4 w-72 h-72 bg-[#2D5EFF] rounded-full mix-blend-screen blur-[120px] opacity-70"
          animate={{ scale: [1, 1.1, 1] }}
          transition={{ repeat: Infinity, duration: 6, ease: "easeInOut" }}
        />
        <motion.div
          className="absolute top-1/3 right-1/4 w-72 h-72 bg-[#4A3AFF] rounded-full mix-blend-screen blur-[120px] opacity-70"
          animate={{ scale: [1, 1.2, 1] }}
          transition={{ repeat: Infinity, duration: 5, ease: "easeInOut" }}
        />
        <motion.div
          className="absolute bottom-1/4 left-1/3 w-72 h-72 bg-[#6B42FF] rounded-full mix-blend-screen blur-[120px] opacity-70"
          animate={{ scale: [1, 1.1, 1] }}
